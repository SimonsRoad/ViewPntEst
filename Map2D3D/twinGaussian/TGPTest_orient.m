function TGPTarget = TGPTest_orient(TestInput, Input, Target, Param, InvIK, InvOK)
% Make the prediction using Twin Gaussian Processess
% IR_orient = EvalKernel(cnn_feat_trn, cnn_feat_test,'rbf',Param.kparam1);
